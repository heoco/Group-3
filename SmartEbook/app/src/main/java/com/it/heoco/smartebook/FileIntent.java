...
public class FileIntent {
    ...
    public static Intent photoIntent(Context context, File photoFile, boolean isGallery) {
        ...
        return isGallery ? chooserIntent : captureIntent;
    }
    ...
    public static File createImageFile(String Directory) throws IOException {
        ...
        if (!mediaStorageDir.exists()) {
            if (!mediaStorageDir.mkdirs()) {
                Log.d(Directory, "Lỗi khởi tạo đường dẫn: " + Directory);
                return null;
            }
        }
        return new File(mediaStorageDir.getPath(), JPEG_FILE_PREFIX + Calendar.getInstance().getTimeInMillis() + JPEG_FILE_SUFFIX);
    }
